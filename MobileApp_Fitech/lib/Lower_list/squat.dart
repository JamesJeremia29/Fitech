          ...
          ? ListTile(
              ...
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => _workoutSQ()));
              },
              trailing: IconButton(
                  onPressed: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => SQinfoPage()));
                  },
...
class SQinfoPage extends StatefulWidget {
  @override
  _SQinfoPageState createState() => _SQinfoPageState();
}

class _SQinfoPageState extends State<SQinfoPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
...
class _workoutSQ extends StatefulWidget {
  @override
  _workoutSQState createState() => _workoutSQState();
}

class _workoutSQState extends State<_workoutSQ> {
