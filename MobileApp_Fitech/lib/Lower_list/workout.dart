...
import 'package:fitech_mobile_apps/home.dart';
import 'package:fitech_mobile_apps/Lower_list/squat.dart';
import 'package:fitech_mobile_apps/Lower_list/mountainClimber.dart';

class lowerPage extends StatefulWidget {
  @override
  _lowerPageState createState() => _lowerPageState();
}
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 5),
                mountainClimberWidget(_isStart)
              ],
            ),
          ),
        )));
