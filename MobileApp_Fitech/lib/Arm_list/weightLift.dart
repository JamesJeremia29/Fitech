...
class weightLiftWidget extends StatefulWidget {
  bool _isStart;
  weightLiftWidget(this._isStart);
  @override
  _weightLiftWidgetState createState() => _weightLiftWidgetState();
}

class _weightLiftWidgetState extends State<weightLiftWidget> {
  @override
    ...
    return Container(
      ...
      child: widget._isStart
          ? ListTile(
              ...
              title: Text("Weight Lift"),
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => _workoutWL()));
              },
              trailing: IconButton(
                  onPressed: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => WLinfoPage()));
                  },
...
class WLinfoPage extends StatefulWidget {
  @override
  _WLinfoPageState createState() => _WLinfoPageState();
}

class _WLinfoPageState extends State<WLinfoPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Weight Lift"),
...
class _workoutWL extends StatefulWidget {
  @override
  _workoutWLState createState() => _workoutWLState();
}

class _workoutWLState extends State<_workoutWL> {
