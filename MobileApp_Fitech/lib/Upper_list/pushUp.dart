...
class pushUpUWidget extends StatefulWidget {
  bool _isStart;
  pushUpUWidget(this._isStart);
  @override
  _pushUpUWidgetState createState() => _pushUpUWidgetState();
}

class _pushUpUWidgetState extends State<pushUpUWidget> {
  @override
          ...
          ? ListTile(
              ...
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => _UworkoutPU()));
              },
              trailing: IconButton(
                  onPressed: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => UPUinfoPage()));
                  },
...
class UPUinfoPage extends StatefulWidget {
  @override
  _UPUinfoPageState createState() => _UPUinfoPageState();
}

class _UPUinfoPageState extends State<UPUinfoPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
...
class _UworkoutPU extends StatefulWidget {
  @override
  _UworkoutPUState createState() => _UworkoutPUState();
}

class _UworkoutPUState extends State<_UworkoutPU> {
            ...
            child: Column(
              ...
              children: [
                ...
                TextButton(
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (_) => upperPage()));
                    },
                    child: Text(
                      'DONE',
