...
class sitUpUWidget extends StatefulWidget {
  bool _isStart;
  sitUpUWidget(this._isStart);
  @override
  _sitUpUWidgetState createState() => _sitUpUWidgetState();
}

class _sitUpUWidgetState extends State<sitUpUWidget> {
  @override
          ...
          ? ListTile(
              ...
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => _UworkoutSU()));
              },
              trailing: IconButton(
                  onPressed: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => USUinfoPage()));
                  },
...
class USUinfoPage extends StatefulWidget {
  @override
  _USUinfoPageState createState() => _USUinfoPageState();
}

class _USUinfoPageState extends State<USUinfoPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
...
class _UworkoutSU extends StatefulWidget {
  @override
  _UworkoutSUState createState() => _UworkoutSUState();
}

class _UworkoutSUState extends State<_UworkoutSU> {
